...
class TermsAndServiceScreen extends StatefulWidget {
  ...
  @override
  State<TermsAndServiceScreen> createState() => _TermsConditionScreenState();
}

class _TermsConditionScreenState extends State<TermsAndServiceScreen> {
      ...
      body: Obx(() {
        switch (infoController.rxRequestStatus.value) {
          ...
          case Status.completed:
            final descriptions = infoController.termsData.value.description??"";
            return Padding(
