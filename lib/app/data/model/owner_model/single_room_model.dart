...
class SingleRoomModel {
  ...
  factory SingleRoomModel.fromRawJson(String str) => SingleRoomModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory SingleRoomModel.fromJson(Map<String, dynamic> json) => SingleRoomModel(
    statusCode: json["statusCode"],
    success: json["success"],
    message: json["message"],
    data: json["data"] == null ? null : SingleRoomModels.fromJson(json["data"]),
  );
...
class SingleRoomModels {
  ...
  factory SingleRoomModels.fromRawJson(String str) => SingleRoomModels.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory SingleRoomModels.fromJson(Map<String, dynamic> json) => SingleRoomModels(
